            ...
            <div className='max-w-5xl mx-auto'>
                ...
                <div className='px-5 lg:px-0 pb-10'>
                    ...
                    <div className='flex flex-col lg:flex-row justify-between items-center gap-5'>
                        ...
                        <div className='flex flex-col items-center gap-5 bg-violet-500 bg-opacity-5 border border-violet-500 border-opacity-20 py-14 px-7 lg:px-14 rounded-lg w-full'>
                            ...
                            <div className='flex flex-col justify-center items-center border border-violet-500 px-5 py-3 rounded-full'>
                                <h3 className='text-xl'> <span className='text-xl font-bold'>1.65M+</span></h3>
                            </div>
